...
try:
    # Đọc file config.csv để lấy scada_id và new_substation_name
    with open(config_file, mode='r') as csvfile:
        ...
        for row in reader:
            ...
            print(f"Đã thay thế tên trạm điện cho SCADA ID {scada_id} thành công và xuất ra file: {output_file}")
